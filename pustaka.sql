...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 19, 2023 at 02:58 AM
...
INSERT INTO `buku` (`id`, `judul_buku`, `id_kategoti`, `pengarang`, `penerbit`, `tahun_terbit`, `isbn`, `stok`, `dipinjam`, `dibooking`, `image`) VALUES
(1, 'Statistika dengan Program Komputer', 1, 'Ahmad Kholiqul', 'Deep Publish', 2014, '021938091238129', 6, 1, 1, NULL),
(2, 'Mudah Belajar Komputer untuk Anak', 1, 'Bambang', 'Huta Media', 2014, '8934752389435', 5, 3, 1, NULL),
(5, 'PHP Komplet', 1, 'jubilee', 'Elex Media Komputindo', 2017, '90752390123', 5, 1, 1, NULL),
(10, 'Detektif Conan Ep 200', 9, 'Okigawa Sasuke', 'Cultura', 2017, '34567893275', 5, 0, 0, NULL);
...
(1, 'Aji Suatmaji', 'aji123@mail.com', 'default.jpg', '$2y$10$4IBeYLmUB2nE7wsFFlD.YOHZAGXDtFpZSkOcbI8oYh5MemTaRlw5q', 2, 0, 1687136084);
